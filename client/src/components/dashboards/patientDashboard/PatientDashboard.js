  ...
  render(){
    return(
      ...
      <div className='row'>
        ...
        <img src={this.state.pic} alt='Unavailable' width='275' height='250'
        className='img-fluid d-block mx-auto rounded-circle'/>
      <h5 className='mt-3 font-weight-bolder text-uppercase text-center'>{this.state.name}</h5>
      <h5 className='mt-3 mb-5 rounded-pill py-2 d-block mx-auto bg-success text-light text-center' style={{"width":"120px","fontFamily":"'Tinos', serif"}}>
      <i className="fa fa-check" aria-hidden="true"></i> Verified</h5>
        </div>
